...
/**
 * Page model for EQ1_22 Details
 * @author:Orina<br> Revision: $Rev$
 */

public class EQ1_22 extends WizardPage {

	public YesNo stepParent;

	public EQ1_22(WebDriver driver) {
		super(driver);

	}

	public EQ1_22 stepParent(String answer, Properties data) {
