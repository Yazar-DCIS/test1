...
/**
 * Page model for EQ1_37_2 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_37_2 extends WizardPage {

	public MultiRadioOptions legalStatus;

	public EQ1_37_2(WebDriver driver) {
		super(driver);

	}

	public EQ1_37_2 childLivingUSUnderLegalStatus(String answer, Properties data) {
