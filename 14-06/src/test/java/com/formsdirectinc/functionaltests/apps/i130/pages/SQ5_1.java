...
public class SQ5_1 extends WizardPage {
	...
	public SQ5_1 spousePriorPetitions_Info(String appliedPriorPetition,
				...
				if (count > 0) {
					for (int i = 0; i < count; i++) {
						...
						priorPetitionerName = new Name_FirstMiddleLast(driver,
								...
								"otherFilingInfo.priorPetitions[" + i
										+ "].name");
						...
						"applicationData-otherFilingInfo.priorPetitions[" + i
								+ "].placeOfFiling");
