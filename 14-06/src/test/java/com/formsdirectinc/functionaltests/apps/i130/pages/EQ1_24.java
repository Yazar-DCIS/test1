...
/**
 * Page model for EQ1_24 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_24 extends WizardPage {

	public YesNo parentLivingInTheUS;

	public EQ1_24(WebDriver driver) {
		super(driver);

	}

	public EQ1_24 parentLivingInTheUS(String answer, Properties data) {
