...
/**
 * Page model for EQ1_24_1 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_24_1 extends WizardPage {

	public YesNo parentInspectedLastEntryUS;

	public EQ1_24_1(WebDriver driver) {
		super(driver);

	}

	public EQ1_24_1 parentInspectedLastEntryUS(String answer, Properties data) {
