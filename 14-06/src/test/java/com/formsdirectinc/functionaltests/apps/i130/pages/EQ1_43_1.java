...
/**
 * Page model for EQ1_43_1 Details
 * @author:Orina<br> Revision: $Rev$
 */

public class EQ1_43_1 extends WizardPage {

	public YesNo livingInUS;

	public EQ1_43_1(WebDriver driver) {
		super(driver);

	}

	public EQ1_43_1 applicantCurrentlyLivingInUS(String answer, Properties data) {
