...
/**
 * Page model for EQ1_29 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_29 extends WizardPage {

	public YesNo proceedings;

	public EQ1_29(WebDriver driver) {
		super(driver);

	}

	public EQ1_29 husbandOrWifeRescissionProceeding(String answer,
			Properties data) {
