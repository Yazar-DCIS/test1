...
/**
 * Page model for EQ1_15 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_15 extends WizardPage {

	public YesNo livingInUS;

	public EQ1_15(WebDriver driver) {
		super(driver);

	}

	public EQ1_15 applicantCurrentlyLivingInUS(String answer, Properties data) {
