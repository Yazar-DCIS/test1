...
/**
 * Page model for EQ1_36_1 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_36_1 extends WizardPage {

	public YesNo lawfulPermanentResident;

	public EQ1_36_1(WebDriver driver) {
		super(driver);

	}

	public EQ1_36_1 lawfulPermanentResident(String answer, Properties data) {
