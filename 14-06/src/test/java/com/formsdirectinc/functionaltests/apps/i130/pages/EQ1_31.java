...
/**
 * Page model for EQ1_31 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_31 extends WizardPage {

	public YesNo presentInUS;

	public EQ1_31(WebDriver driver) {
		super(driver);

	}

	public EQ1_31 physicallyPresent(String answer, Properties data) {
