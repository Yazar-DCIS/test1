...
/**
 * Page model for EQ1_25_2 Details
 * @author:Orina<br> Revision: $Rev$
 */

public class EQ1_25_2 extends WizardPage {

	public YesNo livingInUS;

	public EQ1_25_2(WebDriver driver) {
		super(driver);

	}

	public EQ1_25_2 applicantCurrentlyLivingInUS(String answer, Properties data) {
