...
/**
 * Page model for EQ1_35 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_35 extends WizardPage {

	public YesNo proceedings;

	public EQ1_35(WebDriver driver) {
		super(driver);

	}

	public EQ1_35 husbandOrWifeRescissionProceeding(String answer,
			Properties data) {
