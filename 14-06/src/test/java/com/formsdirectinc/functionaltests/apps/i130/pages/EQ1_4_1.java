...
/**
 * Page model for EQ1_4_1 Details
 * @author:Orina<br> Revision: $Rev$
 */

public class EQ1_4_1 extends WizardPage {

	public YesNo entryInUS;

	public EQ1_4_1(WebDriver driver) {
		super(driver);

	}

	public EQ1_4_1 spouseInspectedLastEntryUS(String answer, Properties data) {
