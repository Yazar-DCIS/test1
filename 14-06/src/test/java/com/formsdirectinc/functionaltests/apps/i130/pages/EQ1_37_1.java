...
/**
 * Page model for EQ1_37_1 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_37_1 extends WizardPage {

	public YesNo childInspectedLastEntryUS;

	public EQ1_37_1(WebDriver driver) {
		super(driver);

	}

	public EQ1_37_1 childInspectedLastEntryUS(String answer, Properties data) {
