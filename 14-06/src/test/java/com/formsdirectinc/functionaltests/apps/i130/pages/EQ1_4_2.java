...
/**
 * Page model for EQ1_4_2 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_4_2 extends WizardPage {

	public MultiRadioOptions legalStatus;

	public EQ1_4_2(WebDriver driver) {
		super(driver);

	}

	public EQ1_4_2 spouseLivingUSUnderLegalStatus(String answer, Properties data) {
