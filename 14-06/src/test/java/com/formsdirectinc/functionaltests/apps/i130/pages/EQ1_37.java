...
/**
 * Page model for EQ1_37 Details
 * @author:Orina<br> Revision: $Rev$
 */
public class EQ1_37 extends WizardPage {

	public YesNo childCurrentlyLivingInUS;

	public EQ1_37(WebDriver driver) {
		super(driver);

	}

	public EQ1_37 childCurrentlyLivingInUS(String answer, Properties data) {
